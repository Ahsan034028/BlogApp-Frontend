  ...
  return (
    <Navbar className='border-b-2'>
      ...
      <Navbar.Collapse>
        ...
        {/* Dropdown for Post options with a dropdown icon */}
        <Navbar.Link active={path === '/create-post' || path === '/update-post/:postId'} as={'div'}>
          <Dropdown label={<span>Post <FaChevronDown className="inline-block ml-1" /></span>} arrowIcon={false} inline>
            <Link to='/create-post'>
